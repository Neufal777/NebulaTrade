...
func InformationDisplayConsole() {
	...
	*/
	...
	fmt.Println(chalk.Bold.TextStyle("Difference to Buy:"), currentPriceFloat-myWallet.LastBuy, chalk.Green)
	fmt.Println(chalk.Bold.TextStyle("Difference to Sell:"), currentPriceFloat-myWallet.LastSell, chalk.Green)
